...
ifdef::env-github[]
image:https://secure.travis-ci.org/graphitefriction/graphitefriction.github.com.png?branch=develop["Build Status", link="https://travis-ci.org/graphitefriction/graphitefriction.github.com"]
endif::[]
